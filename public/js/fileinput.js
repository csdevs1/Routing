...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgNo: 'No',
        msgNoFilesSelected: 'No hay documentos seleccionados',
        msgCancelled: 'Cancelled',
        msgZoomModalHeading: 'Vista Detallada',
        msgFileRequired: 'Debes seleccionar un documento.',
        msgSizeTooSmall: 'File "{name}" (<b>{size} KB</b>) is too small and must be larger than <b>{minSize} KB</b>.',
        msgSizeTooLarge: 'File "{name}" (<b>{size} KB</b>) exceeds maximum allowed upload size of <b>{maxSize} KB</b>.',
        msgFilesTooLess: 'You must select at least <b>{n}</b> {files} to upload.',
        msgFilesTooMany: 'El Numero de documentos a cargar <b>({n})</b> excede el limite maximo<b>{m}</b>.',
        ...
        dropZoneTitle: 'Arrastra y suelta los archivos aqui&hellip;',
        dropZoneClickTitle: '<br>(o click para seleccionar {files})',
